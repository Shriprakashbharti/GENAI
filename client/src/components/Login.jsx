...
const Login = () => {
    ...
    //to disable the scrolling of page when login/signup page is open
    useEffect(()=>{
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 backdrop-blur-sm bg-black/30 flex justify-center items-center z-50'>
        ...
        >
           ...
           {state !== 'Login' && <div className='border px-6 py-2 flex items-center gap-1 rounded-full mt-4'>
